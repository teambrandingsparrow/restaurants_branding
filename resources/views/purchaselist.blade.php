                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive pt-3">
                            <table id="example" class="table table-striped table-bordered dataTables-example">
                                <thead>
                                    <tr>
                                        <th> #</th>
                                        @if (Auth::user()->usertype == 1)
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><span>Product Name</span><span style="float: right">QTY</span></td>
                                        <td></td>
                                    </tr>
                                    @php
                                        $cnt = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 style="display: flex;">
                                                        <a href="{{ url('Purchaseedit', $purchase->id) }}"
                                                            style="margin-left:3%;margin-right:3%;border:none;color:green;"><i
                                                                class="fas fa-edit"></i></a>
                                                        <form action="{{ url('destro', $purchase->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"style="border:none; color: red;background-color: Transparent;
